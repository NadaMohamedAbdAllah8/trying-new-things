...
<head>
    ...
    <title>{{config('global.defaultTitle')}}|Hello</title>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6" x-data="{doc_text_open:false}">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                ...
                                {{-- new link --}}
                                <a x-on.prevent:click="doc_text_open = ! doc_text_open" href="#"
                                    class="underline text-gray-900 dark:text-white">
                                    Documentation-Click to read more!</a>
                            </div>
                        </div>

                        <div class="ml-12" x-show="doc_text_open">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <a href="https://laravel.com/docs" class="underline text-gray dark:text-white">Go to
                                    documentation</a>
                            </div>
                        </div>
                    </div>

                    <div x-data="{text_open:false}"
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                ...
                                {{-- new link --}}
                                <a x-on:click.prevent="text_open = !text_open" href="#" class="underline text-gray-900">
                                    Laracasts-Click to read more!</a>
                            </div>
                        </div>
                        ...
                        <div class="ml-12" x-show="text_open">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                skills in the process. <a href="https://laracasts.com" class="underline text-gray">
                                    Go to Laracasts </a>
                            </div>
                        </div>
                    </div>
